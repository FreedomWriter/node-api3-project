...
export const getUsers = () => dispatch => {
  ...
  axios
    .get(`https://natalie-social.herokuapp.com/api/users/`)
    .then(res => {
      console.log(res);
      // dispatch({
...
export const getUser = id => dispatch => {
  dispatch({ type: USER_GET_START });
  axios
    .get(`https://natalie-social.herokuapp.com/api/users/${id}`)
    .then(res => {
      dispatch({
        type: USER_GET_SUCCESS,
        payload: res.data
...
export const postUser = value => dispatch => {
  ...
  return axios
    .post(`https://natalie-social.herokuapp.com/api/users/`, value)
    .then(res => {
...
export const putUser = (value, id) => dispatch => {
  ...
  axios
    .put(`https://natalie-social.herokuapp.com/api/users/${id}`, value)
    .then(res => {
      dispatch({
...
export const deleteUser = id => dispatch => {
  ...
  axios
    .delete(`https://natalie-social.herokuapp.com/api/users/${id}`)
    .then(res => {
      dispatch({
